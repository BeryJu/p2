...
mv p2_k3s_storage.yaml /var/lib/rancher/k3s/server/manifests/p2-10-storage.yaml
mv p2_k3s_helm.yaml /var/lib/rancher/k3s/server/manifests/p2-20-helm.yaml
